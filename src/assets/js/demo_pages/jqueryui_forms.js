...
var JqueryUiForms = function() {
    ...
    var _componentUiDatepicker = function() {
        ...
        $('.datepicker-icon').datepicker({
            showOn: 'button',
            buttonImage: 'src/assets/images/ui/datepicker_trigger.png',
    ...
    var _componentUiAutocomplete = function() {
        ...
        $('#ac-remote').autocomplete({
            minLength: 2,
            source: 'src/assets/demo_data/jquery_ui/autocomplete.php',
            search: function() {
        ...
        $('#ac-caching').autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON('src/assets/demo_data/jquery_ui/autocomplete.php', request, function(data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            },
